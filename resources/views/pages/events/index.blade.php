                    ...
                    <div class="row shadow">
                        ...
                        <div class="col-md-4 mb-3">
                            <div><label for="number_of_qrs">Number Of Codes Needed</label> <input class="form-control"
                                    id="number_of_qrs" type="number" placeholder="1200" name="number_of_qrs" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            <div>
                                ...
                                <textarea class="form-control" id="color" name="description" required></textarea>
                            </div>
                        </div>
