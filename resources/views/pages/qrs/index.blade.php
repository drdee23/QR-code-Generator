            ...
            <div id="addevent">
                <form method="POST" enctype="multipart/form-data" action="{{ route('event.store') }}">
                    ...
                    <div class="row shadow">
                        ...
                        <div class="col-md-6 mb-3"><label class="my-1 me-2" for="organisation_id">Organisation</label> <select
                                class="form-select" id="organisation_id" name="organisation_id" aria-label="Default select example">
                        ...
                        <div class="col-md-4 mb-3">
                            <div><label for="number_of_qrs">Number Of Codes Needed</label> <input class="form-control"
                                    id="number_of_qrs" type="number" placeholder="1200"
                        ...
                        <div class="col-md-4 mb-3">
                            <div>
                                ...
                                <input class="form-control" id="color" name="start_date" type="datetime-local" 
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            <div>
                                ...
                                <input class="form-control" id="color" name="end_date" type="datetime-local" 
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            <div>
                                ...
                                <textarea class="form-control" id="color" name="description" 
                                    required></textarea>
                            </div>
                        </div>
                    ...
                    <tbody>
                        @foreach ($events as $event)
                            <tr>
                                ...
                                <td><a href="#" class="d-flex align-items-center"><img src="{{ $event->organisation->logo }}"
